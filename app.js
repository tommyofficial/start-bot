...
client.ayarlar = {
	...
	prefix: "yapacağınız ön ek", // Komutların başına gelecek ek
	token: "discord bot developers kısmındaki token",
	klasor: "komutlar", // Komutların bulunduğu klasörün ismi
	renk: "#FF0000", // Embed rengi (HTML kodu veya RANDOM yazılabilir.)
	destek: "discord.gg/davet", // Discord destek sunucusu linki istenirse boş bırakılabilir.
	surum: "0.0.1", // Bot sürümü
	site: "ibd.com", // Botun sitesi istenirse boş bırakılabilir.
	yardimcilar: ["1.ıd","2.ıd"], // İstenirse daha fazla eklenebilir. Eğer yoksa [] içi temizlenebilir.
